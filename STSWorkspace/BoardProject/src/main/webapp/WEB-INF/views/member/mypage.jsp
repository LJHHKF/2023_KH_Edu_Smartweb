...
<body>
			...
			<div class="row align-items-center">
				<div class="col-12">
					<table class="table table-primary table-striped table-bordered">
						<tr>
							<th>ID:</th>
							<td><input type="text" name="id" value="${myDto.id}"
								class="form-control" readonly></td>
						</tr>
						<tr>
							<th>Password:</th>
							<td><input type="password" name="pw" value="${myDto.pw}"
								class="form-control" readonly></td>
						</tr>
						<tr>
							<th>name:</th>
							<td><input type="text" name="name" value="${myDto.name}"
								class="form-control" readonly></td>
						</tr>
						<tr>
							<th>Phone:</th>
							<td><input type="text" name="phone" value="${myDto.phone}"
								class="form-control" readonly></td>
						</tr>
						<tr>
							<th>E-Mail:</th>
							<td><input type="text" name="email" value="${myDto.email}"
								class="form-control" readonly></td>
						</tr>
						<tr>
							<th>ZipCode:</th>
							<td><input type="text" name="zipcode"
								value="${myDto.zipcode}" class="form-control" readonly>
								<button type="button" id="btn_address" style="display: none;"
									class="btn btn-primary">주소찾기</button></td>

						</tr>
						<tr>
							<th>address1:</th>
							<td><input type="text" name="address1"
								value="${myDto.address1}" class="form-control" readonly></td>
						</tr>
						<tr>
							<th>adress2:</th>
							<td><input type="text" name="address2"
								value="${myDto.address2}" class="form-control" readonly></td>
						</tr>
						<tr>
							<th>Join Date:</th>
							<td><input id="join_date" type="date" class="form-control"
								readonly></td>
						</tr>
						<tr>
	...
	<script>
     	...
     	$("#join_date").val(val.substring(0,10));
